...
namespace GenericRepo.InMemoryStorage
{
  public class InMemoryIncludableQuerySet<TModel> : IIncludableQuerySet<TModel> where TModel : class
  {
    private IEnumerable<TModel> data;

    public InMemoryIncludableQuerySet(IEnumerable<TModel> data)
    {
        this.data = data;
    }
